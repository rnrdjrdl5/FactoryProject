...
namespace Tables
{
    public partial class Item
    {
        ...
        public static Item Get(string key) => _table.TryGetValue(key, out var data) ? data : null;
        ...
        public static void Load(System.Collections.Generic.Dictionary<string, byte[]> files)
        {
            ...
            if (files.TryGetValue("Item.json", out byte[] jsonBytes))
            {
                string jsonString = System.Text.Encoding.UTF8.GetString(jsonBytes);
                var data = JsonUtility.Deserialize<System.Collections.Generic.Dictionary<string, Item>>(jsonString);
                if (data != null)
                {
